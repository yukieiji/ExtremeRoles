...
public static class GameSystem
{
	...
	public static bool TryGetKillDistance([NotNullWhen(true)] out Il2CppStructArray<float>? arr)
	{
		...
		if (GameManager.Instance == null ||
			...
			GameManager.Instance.LogicOptions.currentGameOptions == null)
		{
			return false;
		}

		arr = GameManager.Instance.LogicOptions.currentGameOptions.GetFloatArray(FloatArrayOptionNames.KillDistances);
		return arr != null;
	}
}
