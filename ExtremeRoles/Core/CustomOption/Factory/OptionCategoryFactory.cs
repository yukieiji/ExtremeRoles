...
using ExROption = ExtremeRoles.Core.CustomOption.Implemented.CustomOption;
...
using ExtremeRoles.Core.CustomOption.Implemented.Value;



#nullable enable

namespace ExtremeRoles.Core.CustomOption.Factory;
