...
namespace ExtremeRoles.Roles.API
{
    ...
    public abstract class GhostAndAliveCombinationRoleManagerBase : ConstCombinationRoleManagerBase
    {
        public Dictionary<ExtremeRoleId, GhostRoles.API.GhostRoleBase> CombGhostRole = new Dictionary<
            ExtremeRoleId, GhostRoles.API.GhostRoleBase> ();
