...
internal sealed class CompatModMenu
{
	...
	public static void CreateStartMenuButton(SimpleButton template, Transform parent)
	{
		...
		mngButton.Text.text = Translation.GetString("compatModMenuButton");
		...
		string name, int posIndex)
	{
		...
		modText.text = Translation.GetString(name);
	...
	private void createDowngradeButton(SimpleButton template)
	{
		...
		this.downgradeButton.Text.text = Translation.GetString(
	...
	private void initMenu(SimpleButton template)
	{
		...
		title.name = "title";
		title.text = Translation.GetString(titleName);
	...
	private void updateTranslation()
	{
		...
		{
			menu.Text.text = Translation.GetString(mod.ToString());
	...
	{
		button.Text.text = Translation.GetString(buttonType.ToString());
	}
