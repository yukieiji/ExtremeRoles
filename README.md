...
## 追加役職一覧(Extreme Roles v3.3.0.4時点、今後も追加予定)
#### ホスト役職
- シオン
#### 通常役職
|  クルー  |  インポスター  | ニュートラル |
...
## 現在確認されている不具合
- Extreme Roles ModマネージャーよりインストールできるExtreme Skinsのファイルが間違っている問題(現開発版にて修正済み)
...
| ---- | ---- |
|  v2022.10.18s/v2022.10.18e  |  v3.3.0.3 ～ v3.3.0.4 |
