...
- Extreme Roles v2025.12.15.0時点、今後も追加予定
...
- ホストとクライアント間でプリセット番号が異なる時にロビーに入ると負荷が増大する問題
  - 影響度: 大
  - これが発生すると無限ループに近い処理が発生し、設定等がリセットされてしまうことが発生することを確認しています
  - 原因等調査中、v2015.12.15のオプション調整とModクライアント識別調整による処理エラーだと思われます
  - v2026.1.9で修正完了予定
- エクスポートしたオプションの読み込みに失敗してしまう不具合
  - 影響度: 中
  - オプションが中途半端に読まれることもなく失敗することを確認しています
  - v2026.1.9で修正完了予定
...
- ベイト: 想定外の形でキルクールタイムボーナスを得ることが出来てしまう不具合
  - 影響度: 中
    - 発生条件はベイトが覚醒している状態かつ特殊なキルでキルされないと発生しないが、発生するとゲームバランスが少し変わるため
    - v2026.1.9で修正完了予定
  - 対応チケット: [#688](https://github.com/yukieiji/ExtremeRoles/issues/688)
  - 対応策: キルクールタイムボーナスを無効化しておく(恐らく有効にすることは少ないと思うが)
...
| ---- | ---- |
|  v17.0.0(v2025.9.9)/v17.0.1(v2025.10.14)/v17.1.0(v2025.11.18)  | v2025.9.10.0 ～ v2025.12.21 |
