...
## 追加役職一覧(Extreme Roles v5.0.0.5時点、今後も追加予定)
#### ホスト役職
- シオン
#### 通常役職
|  クルー  |  インポスター  | ニュートラル |
...
* 「ラバーズ」、「サポーター」と「ゲッサー」はオプション設定によりインポスターにもなります。(デフォルトはクルー)
...
## 現在確認されている不具合
- フェイカー
  - ダミー(プレイヤー)が正しく動作しない不具合(開発版にて修正済み)
- ウィスプ
  - 勝利判定が正しくない不具合(開発版にて修正済み)
- 役職によるアドミン周りの制限が正しく動作していない不具合
...
| ---- | ---- |
|  v2022.12.08s/v2022.12.08e/v2022.12.14s/v2022.12.14e  |  v5.0.0.0 ～ v5.0.0.5 |
