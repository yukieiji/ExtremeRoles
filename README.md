...
## 追加役職一覧(Extreme Roles v2.0.6.0時点、今後も追加予定)
|  クルー  |  インポスター  | ニュートラル |
| ---- | ---- | ---- |
...
## リリーススケジュール
- Extreme Roles v2.1.0.0 with Extreme Skins v2.1.0.0:：
   - 5月下旬頃予定リリース予定
   - Extreme Roles側：
     - コンビネーション役職アップデート
     - コンビネーション役職を3つ、それぞれだと合計で8つの役職を実装予定
   - Extreme Skins側：
     - カスタムバイザー機能アップデート
     - カスタムハット、カスタムネームプレートに次ぐ自分自身で追加、テストが容易なカスタムバイザー機能を実装予定
- Extreme Roles v2.2.0.0:
   - 6月上旬頃予定、幽霊役職アップデート
   - Extreme Rolesで「幽霊」がアサインされる役職「幽霊役職」(バニラの守護天使みたいなもの)の実装を可能にする拡張を行い、いくつか「幽霊役職」を実装します
...
| ---- | ---- |
|  v2022.03.29s/v2022.03.29e/v2022.04.19e  |  v2.0.5.0 ～ v2.0.6.0 |
