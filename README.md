...
## 追加役職一覧(Extreme Roles v2.1.1.0時点、今後も追加予定)
|  クルー  |  インポスター  | ニュートラル |
| ---- | ---- | ---- |
...
- ヒーローの第一段階に正しく移行しない不具合(#80 v2.2.0.0の開発版にて修正済み)
- カーペンターのネジが0本になるような能力発動条件可で能力が使用できない不具合(ネジを1本増やす設定していただければ動作します、v2.2.0.0の開発版にて修正済み)
- カーペンターのネジ能力使用時の本数が正しく変化しない不具合(表示上の問題、v2.2.0.0の開発版にて修正済み)
...
| ---- | ---- |
|  v2022.03.29s/v2022.03.29e/v2022.04.19e  |  v2.0.5.0 ～ v2.1.1.0 |
