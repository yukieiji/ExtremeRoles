...
## リリーススケジュール
- Extreme Roles v3.2.0.0 with Extreme Skins v3.2.0.0
  - 7月29日(金)リリース予定
  - Extreme Roles夏の大型アップデート「ニュートラル」
  - 第三陣営が少ない問題に対処するため多数の第三陣営をリリースします
  - スキン側はスキンのダウンロード速度の爆速化を行います
...
| ---- | ---- |
|  v2022.06.21s/v2022.06.22e/v2022.07.12s/v2022.07.12e  |  v3.0.0.0 ～ v3.1.3.0 |
