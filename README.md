...
## 実装済み機能と役職
- アサシンの特殊会議発生時、インポスターだけが使用できるチャット機能(けむりさん提案)：v1.12.4.0で実装
...
- ベントガイスト、ベントを動かせるインポスター幽霊役職(ふにちかさん提案)：v2.2.0.0で実装
- サバイバー、タスクをやらないと死亡時確定敗北してしまうクルー(のえぞうさん提案)：v3.0.0.0で実装
