...
## 追加役職一覧(Extreme Roles v2.0.0.0時点、今後も追加予定)
|  クルー  |  インポスター  | ニュートラル |
| ---- | ---- | ---- |
...
## 現在確認されている不具合
- Extreme SkinsのAmongUs v2022.03.29の不具合は#34を参照
- ラバーズ
  - 以下の条件下の時、インポスターのラバーズにアサインされた人のキルボタンが虚無にになり常時キルが可能になる不具合(現在開発中のバージョンで修正済み)
    1. ラバーズのオプション「インポスターがアサインされるか」：オン
    2. ラバーズのオプション「インポスターのアサインレート」：10％以上
    3. ラバーズのオプション「別役職の能力を持つ」：オン
    4. ラバーズのオプション「第三陣営かどうか」：オン
    5. ラバーズのオプション「第三陣営に変化する」：オン 
    6. ラバーズのオプション「別のキルクールタイムを持つ」：オン
## リリーススケジュール
...
| ---- | ---- |
|  v2022.03.29s/v2022.03.29e  |  v1.99.90.0～v2.0.0.0 |
