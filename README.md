...
## 現在確認されている不具合
- オプションプリセット2以降の値が正しく保存とロードがされない問題(現在開発中のバージョンで修正済み、オプションのエクスポート/インポート機能を用いてセーブ＆ロードをお願いします)
- オプションプリセット切替時、翻訳が正しく行われない問題(現在開発中のバージョンで修正済み、翻訳が行われていないオプションを変更することで正しく変更されます)
- ランダムマップ有効時、ウォッチドックの能力が使えない問題(現在開発中のバージョンで修正済み)
