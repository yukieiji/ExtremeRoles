...
- Extreme Roles v2.1.0.0：
   - 5月下旬頃予定、コンビネーション役職アップデート
   - コンビネーション役職を3つ(合計で役職を8つ)
- Extreme Roles v2.1.x.x with Extreme Skins v2.1.0.0:
   - 5月末頃予定、カスタムバイザー機能実装
- Extreme Roles v2.2.0.0:
   - 6月上旬頃予定、幽霊役職アップデート
   - Extreme Rolesで「幽霊」でアサインされる役職「幽霊役職」(バニラの守護天使みたいなもの)の実装を可能にする拡張を行い、いくつか「幽霊役職」を実装します
...
| ---- | ---- |
|  v2022.03.29s/v2022.03.29e/v2022.04.19s/v2022.04.19e  |  v2.0.5.0 |
