...
public class WinnerContainerTests : SerialTestBase, IClassFixture<SerialFixture>, IClassFixture<UnityCommonMock>
{
    public WinnerContainerTests(SerialFixture fixture, UnityCommonMock unityCommonMock)
