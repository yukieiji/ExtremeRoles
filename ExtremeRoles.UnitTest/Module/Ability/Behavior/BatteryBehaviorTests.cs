...
public class BatteryBehaviorTests : SerialTestBase, IClassFixture<SerialFixture>, IClassFixture<UnityCommonMock>
{
    public BatteryBehaviorTests(SerialFixture fixture, UnityCommonMock unityCommonMock)
