...
public class ChargingCountBehaviourTests : SerialTestBase, IClassFixture<SerialFixture>, IClassFixture<UnityCommonMock>
{
    public ChargingCountBehaviourTests(SerialFixture fixture, UnityCommonMock unityCommonMock)
