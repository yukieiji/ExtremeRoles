...
public class ChargingAndReclickCountBehaviorTests : SerialTestBase, IClassFixture<SerialFixture>, IClassFixture<UnityCommonMock>
{
    public ChargingAndReclickCountBehaviorTests(SerialFixture fixture, UnityCommonMock unityCommonMock)
