...
public class CountBehaviorTests : SerialTestBase, IClassFixture<SerialFixture>, IClassFixture<UnityCommonMock>
{
    public CountBehaviorTests(SerialFixture fixture, UnityCommonMock unityCommonMock)
