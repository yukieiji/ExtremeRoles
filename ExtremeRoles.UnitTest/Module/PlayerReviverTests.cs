...
public class PlayerReviverTests : SerialTestBase, IClassFixture<SerialFixture>, IClassFixture<UnityCommonMock>
{
    public PlayerReviverTests(SerialFixture fixture, UnityCommonMock unityCommonMock)
