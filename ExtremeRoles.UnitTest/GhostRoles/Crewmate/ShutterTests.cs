...
public sealed class ShutterTests : IDisposable
{
    public ShutterTests()
    {
    ...
    public void GetRoleFilter_ReturnsPhotographerRole()
    {
        ...
        HashSet<ExtremeRoleId> filter = shutter.GetRoleFilter();
    ...
    [Fact]
    public void CreateSpecificOption_CreatesShutterOptions()
    {
        ...
        var shutter = new Shutter();
        shutter.CreateRoleSpecificOption(factory);
    }
    ...
    public void CreateAbility_ConfiguresButtonAndLabel()
    {
        ...
        Assert.NotNull(shutter.Button);
    }

    [Fact]
    public void GhostPhotoSerializer_DefaultConstructor_HasExpectedProperties()
    {
