...
public sealed class SaboEvilTests
{
    ...
    public void GetRoleFilter_ReturnsEmptySet()
    {
        ...
        HashSet<ExtremeRoleId> filter = saboEvil.GetRoleFilter();
    ...
    public void CreateSpecificOption_CreatesCountButtonOption()
    {
        ...
        saboEvil.CreateRoleSpecificOption(factory);
    }
    ...
    public void CreateAbility_ConfiguresButtonAndLabel()
    {
        ...
        saboEvil.CreateAbility();

        Assert.NotNull(saboEvil.Button);
    }
    ...
    private static void SetupHudManagerMock()
    {
        ...
        var mockSabotageButton = new Mock<SabotageButton>(IntPtr.Zero);
        mockSabotageButton.SetupGet(s => s.graphic).Returns(mockSpriteRenderer.Object);
        ...
        mockHud.SetupGet(h => h.SabotageButton).Returns(mockSabotageButton.Object);
    }
}
