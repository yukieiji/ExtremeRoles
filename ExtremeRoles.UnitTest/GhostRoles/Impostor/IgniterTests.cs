...
public sealed class IgniterTests
{
    public IgniterTests()
    {
    ...
    [Fact]
    public void GetRoleFilter_ReturnsLastWolfRole()
    {
        var igniter = new Igniter();

        HashSet<ExtremeRoleId> filter = igniter.GetRoleFilter();
    ...
    [Fact]
    public void CreateSpecificOption_CreatesIgniterOptions()
    {
        ...
        igniter.CreateRoleSpecificOption(factory);
    }
